const workHistory = [
  ...
  },
  {
    ...
    workDes: [
      "Integrating crucial business features",
      "Responsible for timely deliveries of features and coordination with other teams",
      "Responsible for code refactoring, writing cleaner and scalable code",
    ],
    exposer: [
      "React",
      "NextJS",
