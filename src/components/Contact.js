...
const Contact = () => {
  return (
    <section className='my-28' id='contact'>
      ...
      <div className='md:mx-6 flex flex-col flex-wrap md:flex-row justify-between mt-48'>
          ...
          <div className='flex flex-row flex-wrap mt-7'>
            ...
            <div className='mr-4'>
              <a href={RESUME_PATH} target='_blank' rel='noreferrer'>
                <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
                  <img src='./images/icons/resume1.png' alt='' className='mr-1'
                    style={{
      ...
      <div className='relative md:bottom-24 mr-auto ml-auto md:mr-auto md:ml-0 max-w-xs md:max-w-sm cursor-pointer' onClick={() => window.scroll(0, 0)}>
        <picture>
